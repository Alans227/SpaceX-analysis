Explore SpaceX's Falcon9 launches as part of the IBM Data Science course. All files in this repository are part of the final assignment for this course.

The following jupyter notebooks can be found in the repository:
1) Collecting information using Rest API and BeautifulSoup
2) Data processing (numpy, pandas, sqlalchimy)
